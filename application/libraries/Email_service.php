...
class Email_Service  {
    ...
    public function __construct() {
        ...
        $this->head = 'Driver Repair 24x7';
        $this->from = 'abbasdigitalmarket@gmail.com';
        $this->regards = 'Driver Repair 24x7 team';
    ...
    public function send_register_cutomer_email($data) {
        if($this->IS_SMTP_ACTIVE) {
           $this->CI = & get_instance();
                ...
                $attachment .= 'Hq';
                $contant    = $attachment;
                $subject    = " SreaderTechno Solution Registraion Succeessfully Done.";
