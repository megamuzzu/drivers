                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="page_url" name ="page_url" class="form-control" required="required" placeholder="Exmp: driverfixer/printers/hp_printer_support " value="<?php echo $edit_data->page_url; ?>" >
                                    </div>
                                    <!--Meta Title -->                             
                                    <div class="form-group">
