  ...
  <div class="container-fluid">
    <div class="row">
     ...
     <div class="text-left ">
      ...
      <h5 class="pt-2"><strong style="text-transform: uppercase;" >Drivers for all Brother Printer</strong></h5>
      <p class="mb-0 text-justify text-center" style="font-size: 13px;">Driver Repair 24x7 Updater sources driver updates directly from Brother's website for almost all makes and models. </p>  <p class="mb-0 text-justify text-center" style="font-size: 13px;">Additional functionality and services include enhanced app experiences, deceptive software protection, system cleanup, and assisted support.</p>
