  ...
  <div class="container-fluid">
    <div class="row">
     ...
     <div class="text-left ">
      ...
      <h5 class="pt-2"><strong style="text-transform: uppercase;" >Drivers for all Epson Printer</strong></h5>
      <p class="mb-0 text-justify text-center" style="font-size: 13px;">Driver Repair 24x7 Updater sources driver updates directly from Epson's website for almost all makes and models. </p>  <p class="mb-0 text-justify text-center" style="font-size: 13px;">Additional functionality and services include enhanced app experiences, deceptive software protection, system cleanup, and assisted support.</p>
    ...
    <div class="row">
          <div class=" col-md-6  br-rg">
           ...
           <div class="col-md-6">
            ...
            <p>driverfixer is a leading IT solutions and services organization, dedicated towards creating high-quality system optimization software and utilities. That’s what we focus on with this certification, both for products like Driver Repair 24x7 and services like Driver Repair 24x7 Customer Services.</p>
