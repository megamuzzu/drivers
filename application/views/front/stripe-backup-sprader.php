...
.headdingDiv {
    ...
    background-image: linear-gradient(to right, #13273a 0%, #43607c 51%, #13273a 100%);
    color: #fff;
    margin-bottom: 20px;
}
...
<section class="my-2" >
<!-- <form method="post" action="<?php echo base_url('cart/cygatePayment');?>" > -->
<form method="post" id="paymentFrm" action="<?php echo base_url('cart/stripePayment');?>" autocomplete="off" >
      ...
      <div class="box-1"> 
          ...
          <table class="table themeBgBox">
            ...
            foreach($ProductList as $k=>$v){
              ...
              $total = $v->price;
             ?>
            <input type="hidden" name="product[]" value="<?php echo $v->id;?>" />  
            <tr id="protr<?php echo $v->id; ?>" >
             ...
             <div class="productName productNameCon">
              ...
              <td class="last">
                <input readonly id="Quantitypro<?php echo $v->id; ?>" name="no_item[<?php echo $v->id; ?>]" class="no_item no_item<?php echo $v->price;?>" type="number" value="1" min="1" data-price="<?php echo $v->price;?>"  data-id="<?php echo $v->id; ?>" >
              </td>
              ...
              <td> 
                <div class="mb-price pricCon">
                  ...
                  <!-- <p class="wrap-pl-strike"><strike>US $49.90</strike></p> -->
                </div>
              </td>
            </tr>
            <?php  $i++; 
            ...
            <tr>
              <td colspan="3">
                <p style="font-size: 12px;">
                    We automatically bill your Payment Method each term on the calendar day corresponding to the commencement of your paying subscription. You may cancel the subscription anytime by writing to us at <a href="mailto:support@driverrepair24x7.com">support@driverrepair24x7.com</a>. We do not provide refunds or credits for any partial-term subscription periods except for a period of 14 days from the initial date of purchase of  subscription. All <a href="<?= base_url('refund-policy')?>">Refund & cancellations</a> shall be governed as per our policies.
                </p>
              </td>
              <td class="total">
               ...
               <div class="row mt-3  " id="checkoutBtnStipe">
                <div class="col-md-12">
                   <div class="form-group">
                      ...
                      data-email="info@spreadertechnologyllc.com"
