  ...
  <div class="container-fluid">
    <div class="row">
     ...
     <div class="text-left ">
      ...
      <h5 class="pt-2"><strong>Drivers for all your devices</strong></h5>
      <p class="mb-0 text-justify text-center" style="font-size: 12px;">Driver Repair 24x7 Updater sources driver updates directly from the manufacturer's websites for almost all makes and models. </p>  <p class="mb-0 text-justify text-center" style="font-size: 12px;">Additional functionality and services include enhanced app experiences, deceptive software protection, system cleanup, and assisted support.</p>
      <p class="mb-0 text-justify text-center" style="font-size: 12px;">Driver Repair 24x7 ensures you get the correct drivers for your specific make & model Windows PC. </p>
