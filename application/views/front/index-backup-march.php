...
<section class="container mt-3" >
  <div class="row">
    <div class="col-sm-12 py-2 text-center">
      <p class="font-size1 ptag">Driver Repair 24x7 Updater is an independent service provider for software products. It is a tool to help identify out-of-date or missing device drivers. <a href="<?=base_url('software-principles')?>">Software Principles.</a> By downloading you accept the <a href="<?=base_url('privacy-policy')?>">Privacy Policy</a> and <a href="<?=base_url('terms-of-use')?>">Terms and Conditions</a>. Full functionality requires $4.99 monthly subscription. Use of names and trademarks are for reference only and no affiliation is implied with any named third-party companies.</p>
    </div>
  </div>
</section> 
<!--//Download disclaimer -->
