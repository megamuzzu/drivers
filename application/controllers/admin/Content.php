...
class Content extends BaseController
{
    ...
    {
        $this->isLoggedIn();
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Page Content';
        $this->loadViews("admin/content/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->isLoggedIn();
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Add New Page Content';
        $this->loadViews("admin/content/addnew", $this->global, NULL , NULL);
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'admin/content/edit/'.$currentObj->id.'"><i class="fa fa-pencil"></i></a> <a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Edit Page Content';
        $this->loadViews("admin/content/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('admin/content/edit/'.$insertData['id']);
          }  
