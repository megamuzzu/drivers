...
class Sub_category extends BaseController
{
    ...
    {
        $this->isLoggedIn();
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Sub Category';
        $this->loadViews("admin/sub_category/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Add New Sub Category';
    ...
    public function edit($id = NULL)
    {
        ...
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Edit Sub Category';
