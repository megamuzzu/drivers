...
class Product extends BaseController
{
    ...
    {
        $this->isLoggedIn();
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Product';
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<img src ="'.base_url('uploads/product/').$currentObj->image1.'" width="50" alt = "Driver Repair 24x7"/>';
    ...
    public function edit($id = NULL)
    {
        ...
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Edit Product';
