...
class Category extends BaseController
{
    ...
    {
        $this->isLoggedIn();
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Category';
    ...
    public function addnew()
    {
        ...
        $this->isLoggedIn();
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Add New Category';
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row = array();
            $row[] = $no;
            $row[] = '<img src ="'.base_url().'uploads/category/'.$currentObj->image.'" width="50" alt = "Driver Repair 24x7"/>';
            $row[] = $currentObj->name;
            $row[] = $currentObj->status==1?'Active':'InActive';
            $row[] = $date_at;
            
            
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'admin/category/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->global['pageTitle'] = 'Driver Repair 24x7 : Edit Members';
