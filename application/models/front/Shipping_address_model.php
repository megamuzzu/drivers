...
class Shipping_address_model extends Base_model
{
    public $table = "z_users_shipped_address";
    ...
    public function find($id) {
        ...
        public function get_default_address($data)
        {
            ...
            $where['default_address']       = 'default';
            $results = $this->findDynamic($where);
